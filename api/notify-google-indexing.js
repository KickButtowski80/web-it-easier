...
export default async function handler(req, res) {
  ...
  // Use the private key from the Base64-encoded environment variable
  let privateKey;
  ...
  // If key is not found, the function cannot proceed.
  if (!privateKey) {
    throw new Error('Required environment variable GOOGLE_PRIVATE_KEY_BASE64 is missing or invalid.');
  }

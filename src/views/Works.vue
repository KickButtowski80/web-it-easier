...
const Work = defineAsyncComponent(() => import('../components/Work.vue'));

// Create reactive project objects
const projects = [
  reactive({
    projectId: 1,
  ...
  reactive({
    ...
    description: 'Designed and developed a modern e-commerce website for a local pizza restaurant. The site features an interactive menu with customizable pizza options, online ordering system, and delivery tracking. Implemented a responsive design that works seamlessly on all devices, with special attention to mobile user experience. The website includes a loyalty program system, customer reviews section, and real-time order status updates.',
    technologiesUsed: ['Parcel.js', 'JavaScript', 'Tailwind.css', 'HTML'],
    startDate: '',
    endDate: '',
    highlights: [
  ...
  reactive({
    ...
    description: 'A modern space exploration website featuring interactive animations and educational content about space missions. The site includes a 3D rocket animation, mission timeline, and comprehensive information about space exploration. Implemented smooth scrolling effects, parallax backgrounds, and interactive elements that engage users in learning about space technology and history.',
    technologiesUsed: ['Parcel.js', 'JavaScript', 'Tailwind.css', 'HTML'],
    startDate: '',
    endDate: '',
    highlights: [

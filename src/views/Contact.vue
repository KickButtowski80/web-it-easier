<template>
  ...
  >
    ...
    <article
      class="relative md:left-9 grid grid-cols-1 md:grid-cols-2
       max-w-sm md:max-w-xl lg:max-w-3xl p-6 mb-16 md:mb-8
    ...
    >
      ...
      <aside
        id="hire-us-info"
        class="max-w-sm bg-purple-400 p-6 rounded-xl
         absolute -bottom-full md:bottom-9 md:-left-28 min-h-full
        text-blue-700  "
      >
